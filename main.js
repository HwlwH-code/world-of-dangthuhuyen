...
class Tulip {
    constructor(x, y, size) {
        switch (size) {
            case 'random':
                this.relativeSize = (Math.random()*120 + 210) / 2210;
                break;
            case 'XS':
                this.relativeSize = 150 / 2210;
                break;
            case 'S':
                this.relativeSize = 190 / 2210;
                break;
            case 'M':
                this.relativeSize = 230 / 2210;
                break;
            case 'L':
                this.relativeSize = 270 / 2210;
                break;
            case 'XL':
                this.relativeSize = 310 / 2210;
                break;
            case 'XXL':
                this.relativeSize = 350 / 2210;
                break;
        }
    ...
    draw(){
        ctx.drawImage(this.currentImage,
             ...
             this.relativeX * canvas.width - this.relativeSize * (canvas.width + canvas.height) / 4,
             this.relativeY * canvas.height - this.relativeSize * (canvas.width + canvas.height) / 2,
             this.relativeSize * (canvas.width + canvas.height) / 2,
             this.relativeSize * (canvas.width + canvas.height) / 2);
    }
};
